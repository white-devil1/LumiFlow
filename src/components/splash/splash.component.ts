...
@Component({
  ...
  template: `
    <div class="fixed inset-0 bg-[#1E1B4B] z-[100] flex flex-col items-center justify-center text-white transition-opacity duration-1000 overflow-hidden px-4">
      ...
      <div class="relative w-32 h-32 md:w-48 md:h-48 mb-6 md:mb-8 flex items-center justify-center scale-110">
         <div class="absolute inset-0 flex items-center justify-center z-10">
           <!-- Squares: Accelerated Timeline (0s - 1.2s) -->
           <div class="w-7 h-10 md:w-10 md:h-14 bg-blue-500/80 rounded-[2px] absolute"
                style="--sx: -100px; --sy: -80px; --sr: -45deg; animation: fly-to-grid 1.2s cubic-bezier(0.16, 1, 0.3, 1) 0s forwards; opacity: 0; transform-origin: center center; top: 30px; left: 30px;">
           </div>
           <div class="w-7 h-10 md:w-10 md:h-14 bg-cyan-500/80 rounded-[2px] absolute"
                style="--sx: 100px; --sy: -60px; --sr: 30deg; animation: fly-to-grid 1.2s cubic-bezier(0.16, 1, 0.3, 1) 0.1s forwards; opacity: 0; transform-origin: center center; top: 30px; right: 30px;">
           </div>
           <div class="w-7 h-10 md:w-10 md:h-14 bg-indigo-500/80 rounded-[2px] absolute"
                style="--sx: -80px; --sy: 100px; --sr: 25deg; animation: fly-to-grid 1.2s cubic-bezier(0.16, 1, 0.3, 1) 0.2s forwards; opacity: 0; transform-origin: center center; bottom: 30px; left: 30px;">
           </div>
           <div class="w-7 h-10 md:w-10 md:h-14 bg-blue-400/80 rounded-[2px] absolute"
                style="--sx: 120px; --sy: 80px; --sr: -20deg; animation: fly-to-grid 1.2s cubic-bezier(0.16, 1, 0.3, 1) 0.3s forwards; opacity: 0; transform-origin: center center; bottom: 30px; right: 30px;">
           </div>
         </div>
         ...
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="absolute inset-0 w-full h-full overflow-visible drop-shadow-[0_0_25px_rgba(6,182,212,0.3)] z-20">
            ...
            <path d="M10 50 Q 30 20, 50 50 T 90 50" fill="none" stroke="url(#lumiGradient)" stroke-width="4" stroke-linecap="round" 
                  ...
                  style="animation: draw-stroke-once 1.5s ease-out 1.2s forwards; opacity: 0;">
            </path>
            <!-- Dot: Pop 0.5s -->
      ...
      <div class="text-center relative z-10 flex flex-col items-center max-w-sm md:max-w-none">
        <!-- Title: 2.5s Start -->
        <h1 class="text-4xl md:text-7xl font-black tracking-tight text-white mb-4 md:mb-6 drop-shadow-2xl opacity-0" 
            style="animation: fade-in-down 0.8s cubic-bezier(0.22, 1, 0.36, 1) 2.4s forwards;">
        ...
        <div class="flex flex-col items-center gap-2 md:gap-4 min-h-[100px] md:min-h-[140px]">
          <div class="overflow-hidden">
            ...
            <p class="text-lg md:text-2xl font-light text-cyan-50 tracking-[0.2em] opacity-0"
               style="animation: slide-up 0.8s cubic-bezier(0.22, 1, 0.36, 1) 2.6s forwards;">
          ...
          <div class="overflow-hidden">
            ...
            <div class="h-[1px] w-12 bg-gradient-to-r from-transparent via-cyan-500 to-transparent opacity-0 mb-3"
                 style="animation: fade-border-in 1.0s ease-out 2.8s forwards;"></div>
          </div>
          ...
          <div class="overflow-hidden mb-6 md:mb-8">
            ...
            <p class="text-xs md:text-base font-bold text-white tracking-[0.6em] uppercase opacity-0 bg-white/10 px-5 py-2 rounded-full border border-white/10 backdrop-blur-sm shadow-[0_0_20px_rgba(6,182,212,0.15)]"
               style="animation: slide-up 0.8s cubic-bezier(0.22, 1, 0.36, 1) 3.0s forwards;">
              One PDF.
            </p>
          </div>

          <!-- DIVE IN Button - Appears AFTER animations (approx 3.8s) -->
          @if (showButton()) {
            <div class="animate-[zoom-in-up_0.6s_cubic-bezier(0.34,1.56,0.64,1)_forwards] opacity-0" style="animation-fill-mode: forwards;">
